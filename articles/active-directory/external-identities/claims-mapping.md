...
For B2B collaboration users, mapping of attributes accross tenant boundaries is prevented for security reasons. However, you may issue claims from attributes in your own tenant.
