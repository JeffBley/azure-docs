...
- **Require Hybrid Azure AD joined device** - This policy block access has also the potential to block access for all users in your organization if you don't have any Hybrid Azure AD joined devices yet.
